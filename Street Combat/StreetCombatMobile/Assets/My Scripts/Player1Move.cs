...
public class Player1Move : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (SaveScript.TimeOut == false)
        {
            ...
            {
                if (SaveScript.Player1WalkRight == true)
                {
                ...
                if (SaveScript.Player1WalkLeft == true)
                {
                    if (CanWalkLeft == true)
                    {
                        if (WalkLeftP1 == true)
            ...
            if (SaveScript.Player1WalkRight == false && SaveScript.Player1WalkLeft == false)
            {
                Anim.SetBool("Forward", false);
                Anim.SetBool("Backward", false);
            }
            ...
            if (SaveScript.Player1Crouching == true)
            {
                if (CrouchTime < Timer)
                {
