...
public class Player1MoveAI : MonoBehaviour
{
    ...
    public static bool WalkRightAI = true;//walking on both sides of screen an movement conditions and attributes

    public GameObject Restrict;
    public Rigidbody RB;
    public Collider BoxCollider;
    public Collider CapsuleCollider;//collsion checks of characters
    ...
    private bool IsBlocking = false;//characters attacks and defence conditions
    ...
    public void Update()
    {
        ...
        if (SaveScript.TimeOut == false)
        {
            ...
            if (Player1ActionsAI.Dazed == false)
            {
                AIMovements();
            }         
